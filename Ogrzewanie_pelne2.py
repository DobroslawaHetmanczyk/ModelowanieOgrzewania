...
from Ogrzewanie_z_wylaczeniem_grzejnikow2 import z_values
...
file_path ='C:/Users/d-het/PycharmProjects/moddet1/temperature_data_kelvin.csv'
temperature_data = load_temperature_data2(file_path)

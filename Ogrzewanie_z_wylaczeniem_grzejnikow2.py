...
from Ogrzewanie_z_wylaczaniem_grzejnikow1 import update_temperature, calculate_door_means, update_door_temperatures, animate_heat_distribution

def load_temperature_data2(file_path):
    data = pd.read_csv(file_path)
    return data["Temperature (K)"].values
...
file_path2 ='C:/Users/d-het/PycharmProjects/moddet1/temperature_data_kelvin.csv'
temperature_data2 = load_temperature_data2(file_path2)
